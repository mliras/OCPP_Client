...
#ifndef SRC_CHARGEPOINT_H_
#define SRC_CHARGEPOINT_H_
...
//Used by changeAvailability requests
int unavailabilityScheduled[NUM_CONNECTORS];
...
//Escribe un mensaje de log donde le digamos que la muestre (GUI, FICHERO, BD o PANTALLA)
...
int isCPOffline();
//This function obtains the vendor written by the user
const char *getVendor();
//This function obtains the model written by the user
const char *getModel();
//This function obtains meter value of a specific connector
char *getConnectorMeterValue(int connector);
...
//Esta funcion devuelve el idtag dado su reservationId
